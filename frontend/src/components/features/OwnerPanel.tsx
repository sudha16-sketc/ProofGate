  ...
  if (!meta.isOwner) {
    return (
      <EmptyState
        ...
        description={
          <>
            This wallet is not the owner of <span className="mono">{address}</span>. Governance actions are
            restricted to the wallet that holds that deployment's owner secret, so they are unavailable here.
          </>
        }
      />
    );
    ...
    <div className="stack" style={{ gap: 'var(--sp-5)' }}>
      <div className="row-between">
        <div>
          ...
          <p className="muted">
            Owner actions proven in zero-knowledge. Only the holder of the deployment secret can run them.
          </p>
        </div>
        <StatusBadge tone="ok">Owner session</StatusBadge>
      </div>
        ...
        <Card pad="sm">
          <div className="row-between">
            <div>
              ...
              <p className="muted">The two one-click setup steps, plus ownership transfer.</p>
            </div>
          </div>
          <div className="row-wrap" style={{ marginTop: 12 }}>
            ...
            <Button variant="danger" onClick={() => void transferOwnershipAction()} disabled={issuing} loading={busy === 'Transfer ownership'}>
              Transfer ownership
            </Button>
          </div>
        </Card>
    ...
    <Reveal>
      <Card pad="sm">
        <div className="row-between">
          ...
          <StatusBadge tone="dim">owner</StatusBadge>
        </div>
